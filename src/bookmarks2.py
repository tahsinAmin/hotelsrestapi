...
from src.database2 import Bookmark, db
...
def handle_bookmarks():
    ...
    if request.method == 'POST':
        ...
        body = request.get_json().get('body', '') # giving an empty string  as 2nd param  which is a fallback as the body can be nullable
